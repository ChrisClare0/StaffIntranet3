<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliStartRoom.aspx.cs" Inherits="DCGS_Staff_Intranet2.Ezra.EasterHunt.EliStartRoom" %>
...
<body>
    ...
    <div id="bannerEli" class="test1"><br /><br /><br /><br /><br /><br /><br />So Eli,<br />
        <br />
        ...
        <br />
        <asp:Button ID="Button1" runat="server" Text="START"  CssClass="test1" OnClick="Button1_Click" />
